> [!IMPORTANT]
> The tutorial lives in the "_tutorial_" folder (see [build
> instructions](#build-instructions) below).
>
...
command and so on. And most importantly: hopefully, you'll have fun along the
way 😉
...
and the fun can begin! The whole "game" will now take place in this folder
alone. Let's start by reading the README.md _inside of that folder_ 😊
...
A: That is a good question and you will figure out the answer the more you get
into the quests (many of which are impossible in a fresh clone)…
...
and then you are ready! The whole "game" will now take place in this folder
only. Let's start by reading the README.md in that folder 😊
...
If you want to work on this challenge and improve it,
[architecture](./architecture.md) contains a short introduction on how this
